...
<body>
<div class="container">
    <h3 class="text-center">CREATE ACCOUNT FOR EMPLOYER</h3>
    <form method="post">
        <div class="row">
...
<?php
  ...
  if (isset($_POST['register'])) {
      ...
      $check_email = mysqli_query($conn, "SELECT * FROM employer WHERE Email = '$email'");
      ...
      elseif ($password != $confirm_pass) {
         ...
         $register_sql = "INSERT INTO employer (LastName, FirstName, Midname, Company, Email, Password, RegisterDate)
         VALUES ('$lastname', '$firstname', '$midname', '$company', '$email', '$password', NOW())";
